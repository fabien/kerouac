...
Kerouac.prototype.content = function(path, filter) {
  this.plug(plugins.content(path, filter));
}

Kerouac.prototype.assets = 
Kerouac.prototype.static = function(path, filter) {
  this.plug(plugins.assets(path, filter));
}
